...
class ReadMapper2:
    def __init__(self, target:list, bam_path:list, lowest_match=0.2, lowest_match1 = 0.8, small_exon_threshold = 20, small_exon_threshold1=100, truncation_match=0.5, platform = '10x',
                 reference_gtf_path = None):
        self.target = target
        self.bam_path = bam_path
        column_names = ['chromosome', 'source', 'feature', 'start', 'end', 'score', 'strand', 'frame', 'attribute']
